...
async function getsongs(folder) {
  ...
  for (const song of songs) {
    songul.innerHTML = songul.innerHTML + `<li><img src="imgs/music.svg" alt="">
        <div class = "songinfo">
            <div>
              ${song}
            </div>
        </div> 
        <img src="imgs/play.svg" alt=""></li>`;
  }
...
const playmusic = (track, pause = false) => {
  ...
  document.querySelector(".songname").innerHTML = `<span class = "name">${track}</span>`
